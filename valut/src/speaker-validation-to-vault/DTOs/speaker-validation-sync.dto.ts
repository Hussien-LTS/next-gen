...
export class ContractFee {
  ...
  @ApiPropertyOptional({ example: 'Speaker' })
  @IsOptional()
  @IsString()
...
export class ContractDetail {
  ...
  @ApiPropertyOptional({ example: 'MSA - Master Speaker Agreement' })
  @IsOptional()
  @IsString()
  Type?: string;
}
...
export class SyncSpeakerDto {
  @ApiProperty({ example: 'V83Z025E827ZDNP' })
  @IsNotEmpty()
  @IsString()
  eventSpeakerId: string;
    ...
    example: [
      {
        ...
        success: false,
        HCPId: 'HCP56305',
        EventSpeakerId: 'a2t5C0000008ombQAA',
        errorMessage: [
          'Cap Rule Limit Exceeds:Corporate Cap',
          'Cap Rule Limit Exceeds:Corporate Cap 1',
        ],
        ...
        contractDetails: [
          {
            ...
            Status: 'Accepted',
            Tier: 'Tier1',
            Type: 'MSA - Master Speaker Agreement',
          },
        ],
        capDetails: [
          {
