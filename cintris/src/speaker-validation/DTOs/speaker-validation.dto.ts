...
export class SpeakerInfoValidationDTO {
  ...
  @ApiProperty({ example: "Event_Speaker" })
  @IsString()
  @IsNotEmpty()
...
export class SpeakerValidationDTO {
  @ApiProperty({ type: SpeakerInfoValidationDTO })
  @ValidateNested()
  @Type(() => SpeakerInfoValidationDTO)
  speakerinformation: SpeakerInfoValidationDTO;
}
